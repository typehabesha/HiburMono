...
have *alredy* been patched for the Nerd Fonts glyphs 
...
Additional fonts can be provided upon request. To do so, open a GitHub [issue](https://github.com/typehabesha/HiburMono/issues).

Patching of the Nerd Fonts glyphs *into* Hibur Mono is provided in the
file:

 * HiburMonoNerdFont-Regular.ttf
